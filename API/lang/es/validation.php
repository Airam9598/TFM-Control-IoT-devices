...
return [
    ...
    */
    ...
    'password' => [
        'letters' => 'La contraseña debe contener al menos una letra mayúscula, otra minúscula, un carácter especial y como mínimo 8 carácteres',
        'mixed' => 'La contraseña debe contener al menos una letra mayúscula, otra minúscula, un carácter especial y como mínimo 8 carácteres',
        'numbers' => 'La contraseña debe contener al menos una letra mayúscula, otra minúscula, un carácter especial y como mínimo 8 carácteres',
        'symbols' => 'La contraseña debe contener al menos una letra mayúscula, otra minúscula, un carácter especial y como mínimo 8 carácteres',
        'uncompromised' => 'La contraseña escrita ha sido filtrada anteriormente. Por favor elige otra.',
    ],
    'lte' => [
    ...
    'min' => [
        'numeric' => 'El campo :attribute debe tener como mínimo :min.',
    ...
    */
    ...
    'custom' => [
        'name' => [ 'onlyLetters'=> 'El nombre solo puede contener letras.',
            'required'=>'El nombre es necesario.',
            'min'=>'El nombre debe tener por lo menos :min carácteres.',
            'max'=>'El nombre debe tener menos de :max carácteres.'],
        'surnames' => [ 'onlyLetters'=> 'Los apellidos solo puede contener letras.',
            'required'=>'Los apellidos son necesarios.',
            'min'=>'Los apellidos deben tener por lo menos :min carácteres.',
            'max'=>'Los apellidos deben tener menos de :max carácteres.',],
        'dni' => [ 'format'=> 'El DNI no tiene el formato correcto (00000000X)',
            'required'=>'El DNI es necesario.'],
        'password'=>['required'=>'La contraseña es obligatoria',
            'symbols'=>'La contraseña debe tener por lo menos un símbolo'],
        'password_confirmation'=>['required'=>'La confirmación de contraseña es necesaria',
        'same'=>'Las contraseñas no son iguales'],
        'login'=>['error'=>'Email o contraseña incorrectos'],
        'exist'=>['error'=>':attribute no existe']
